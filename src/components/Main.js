                ...
                <Container>
                    ...
                    {mq ? (
                        <Contact
                            click={+click}
                            target="_blank"
                            to={{ pathname: "mailto:sh981013s@gmail.com" }}
                        >
                            <motion.h3
                                initial={{
                                    y: -200,
                    ...
                    {mq ? (
                        <BLOG click={+click} target="_blank" to={{pathname:'https://hwani.dev/'}}>
                            <motion.h2
                                initial={{
                                    y: -200,
                                    transition: { type:'spring', duration: 1.5, delay:1 }
                        ...
                        <BLOG click={+false} target="_blank" to={{pathname:'https://hwani.dev/'}}>
                            <motion.h2
                                initial={{
                                    y: -200,
                                    transition: { type:'spring', duration: 1.5, delay:1 }
